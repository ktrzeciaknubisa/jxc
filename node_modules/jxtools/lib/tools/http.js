  ...
  var _download = function () {
    ...
    req = mod.get(_options, function (res) {
      ...
      if (localFile) {
        ...
        file.on('finish', function () {
          consoleEx.debugInfo('downloader response end: closing file');
          file.close();
          return _exit();
        });
      }
      ...
      res.on('data', function (chunk) {
        ...
        consoleEx.debugInfo('downloader response end called');
        ...
        if (localFile) {
          ...
          consoleEx.debugInfo('downloader response end: ending file');
    ...
    if (options.timeout) {
      req.setTimeout(options.timeout, function() {
        consoleEx.debugInfo('downloader forcing timeout');
        req.abort();
      });
    }
  };
